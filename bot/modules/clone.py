...
from bot import LOGGER, download_dict, download_dict_lock, Interval, config_dict, status_reply_dict_lock, bot, user, IS_PREMIUM_USER
...
async def cloneNode(client, message):
    ...
    if is_gdrive_link(link):
        ...
        if config_dict['STOP_DUPLICATE']:
            ...
            if smsg:
                msg = "<code>File/Folder ini sudah ada di GDrive!</code>\n<code>Hasil pencarian :</code>"
