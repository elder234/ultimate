...
from bot import aria2, LOGGER, DOWNLOAD_DIR, get_client, MAX_SPLIT_SIZE, config_dict, user_data, GLOBAL_EXTENSION_FILTER
...
async def take_ss(video_file, duration):
    ...
    status = await create_subprocess_exec("opera", "-hide_banner", "-loglevel", "error", "-ss", str(duration),
