    ...
    try:
        ...
        if op.lower() == "ok.":
            ...
            if await getDownloadByGid(ext_hash[:12]):
                await sendMessage(listener.message, "Torrent ini sudah ditambahkan!")
                return
        else:
            await sendMessage(listener.message, "Torrent tidak valid!")
            return
            ...
            for tor_info in await sync_to_async(client.torrents_info):
                if tor_info.state == "metaDL":
                    ...
                    if tor_info.hash not in RECHECKED and 0.99989999999999999 < tor_info.progress < 1:
                        ...
                        bot_loop.create_task(__onDownloadError(
                    ...
                    bot_loop.create_task(__onDownloadError(
                        "Penyimpanan tidak cukup!", client, tor_info))
